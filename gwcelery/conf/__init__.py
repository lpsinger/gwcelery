...
"""The VOEvent listener will connect to this address to receive GCNs. If this
is an empty string, then completely disable the GCN listener. For options, see
`GCN's list of available VOEvent servers
<https://gcn.gsfc.nasa.gov/voevent.html#tc2>`."""
